...
//  lv_label_set_text(ui_Label34, buffer);
//  lv_disp_load_scr(ui_view_message1);
//  lv_refr_now(NULL);
//  HAL_Delay(500);
...
//  OLED_Clear();
  ...
  {
    /* USER CODE END WHILE */
	  uint8_t atBuf[21] = "AT+SEND=110,5,HELLO\r\n";
//	  if(numSent == 10){
//		  buffer[0] = "g";
//		  buffer[1] = "o";
//		  buffer[2] = "t";
...
//		  buffer[5] = "t";
//		  buffer[6] = "!";
////		  HAL_UART_Transmit(&huart2, atBuf, 21,100);
//	  }
	  HAL_Delay(2000);
	  numSent += 1;
    /* USER CODE BEGIN 3 */
...
void LoRa_init(){
//	uint8_t address[3] = "AT\r";
//	uint8_t address[21] = "AT+DADDR=01:02:0A:0B\r";
//	uint8_t network[13] = "AT+NWKID=64\r";
//	uint8_t battery[9] = "AT+BAT=?\r";
...
//	HAL_Delay(500);
	...
	HAL_UARTEx_ReceiveToIdle_DMA(&huart2, buffer, sizeof(buffer));
//	HAL_UART_Receive(&huart2, buffer, sizeof(buffer)-1, 1000);

	HAL_UART_Transmit(&huart2, at, sizeof(at), 100);
	HAL_Delay(500);
